...
class SearchResultComponent extends StatefulWidget {
 ...
 final String linkToGo;
  ...
  const SearchResultComponent(
      {Key? key, required this.link, required this.description, required this.linkToGo,   required this.text})
      : super(key: key);
...
Text(widget.description, style:const TextStyle(fontSize:14, color: primaryColor ),),
